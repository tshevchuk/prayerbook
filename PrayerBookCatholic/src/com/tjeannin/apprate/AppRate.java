...
public class AppRate implements android.content.DialogInterface.OnClickListener, OnCancelListener {
	...
	private void showDefaultDialog() {
		...
		String title = "Залиште відгук про " + getApplicationName(hostActivity.getApplicationContext());
		String message = "Якщо Вам подобається " + getApplicationName(hostActivity.getApplicationContext()) + ", будь ласка, приділіть хвильку часу і напишіть відгук. Дякую Вам за підтримку!";
		String rate = "Залишити відгук !";
		String remindLater = "Нагадати пізніше";
		String dismiss = "Ні, дякую";

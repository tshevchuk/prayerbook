...
import com.tshevchuk.calendar_validation.comparators.day_comparator.NewsUgccPersonComparator;
 ...
 */
public class CompareNewsUgccPersonTask extends CommandLineTask {
    @Override
    public String getCommand() {
        return "--compare-news_ugcc-person";
    }

    @Override
    public String getDescription() {
        return "--compare-news_ugcc-person <from_year> <to_year>" +
                "\n   Порівняти святих у згенерованому календарі і в календарі http://news.ugcc.ua/calendar/ , збереженому в json";
    }
    ...
    public void execute(String[] args) throws IOException, InvalidFormatException {
        ...
        String res = new CalendarComparator(new NewsUgccPersonComparator())

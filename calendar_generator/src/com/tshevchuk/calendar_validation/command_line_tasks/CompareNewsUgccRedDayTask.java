...
import com.tshevchuk.calendar_validation.comparators.day_comparator.NewsUgccRedDayComparator;
 ...
 */
public class CompareNewsUgccRedDayTask extends CommandLineTask {
    @Override
    public String getCommand() {
        return "--compare-news-ugcc-red-day";
    }

    @Override
    public String getDescription() {
        return "--compare-news-ugcc-red-day <from_year> <to_year>" +
                "\n   Порівняти червоний день у згенерованому календарі і в календарі http://news.ugcc.ua/calendar/ , збереженому в json";
    }
    ...
    public void execute(String[] args) throws IOException, InvalidFormatException {
        ...
        String res = new CalendarComparator(new NewsUgccRedDayComparator())

...
public class Catalog {
    public static final String AUDIO_BASE_URL = "https://ukrainian-prayers.firebaseapp.com/Audio_Molytovnyk_mp3_128/";
    ...
    private static final String SRC_AUDIO_KATEKH_KOMISIYA = "Катехитична комісія Києво-Галицького Верховного Архиєпископства УГКЦ http://kk-kgva.org.ua/index.php/audiomolytovnyk.html , читає - о. Юрій Цегельський. Запис здійснено на студії Воскресіння. Живе Радіо у Львові";
    private static final int ID_SCHODENNI_MOLYTVY = 1;
    private static final int NEXT_ID_TO_ADD = 921;
...

    {
        ...
        menu.html(ID_SCHODENNI_MOLYTVY, "Щоденні молитви",
                ...
                .setAudio("01_Shodenni_Molytvy.mp3", SRC_AUDIO_KATEKH_KOMISIYA)
    ...
    private MenuItemSubMenu addMolytvyRizni() {
        ...
        menu.html(2, "Ранішні молитви", "texts/molytvy/molytvy-ranishni.html",
                ...
                .setAudio("02_Ranishni_molytvy.mp3", SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
        ...
        menu.html(3, "Вечірні молитви", "texts/molytvy/molytvy-vechirni.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("03_Vechirni_molytvy.mp3",SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
    ...
    private MenuItemSubMenu addMolytvyNaProslavuUkrSluhBozhykh() {
        ...
        menu.text(577, "Молитва за прославу митрополита Андрея Шептицького",
                ...
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
            .setAudio("06_Molytvy_na_rizni_potreby/33_Molytva_za_proslavu_mutropolyta_A_Sheptytskoho.mp3",
                    SRC_AUDIO_KATEKH_KOMISIYA);
    ...
    private MenuItemSubMenu addMolytvyDoSvyatykh() {
        ...
        menu.text(567, "Молитва до святого Володимира",
                ...
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
            .setAudio("07_Molytvy_do_ukrainskykh_sviatykh/34_Molytva_do_sv_kn_Volodymyra.mp3",
                    SRC_AUDIO_KATEKH_KOMISIYA);
        menu.text(568, "Молитва до святої княгині Ольги",
                "texts/molytvy-do-svyatykh/olhy.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
            .setAudio("07_Molytvy_do_ukrainskykh_sviatykh/35_Molytva_do_sv_kn_Olhy.mp3",
                    SRC_AUDIO_KATEKH_KOMISIYA);
        menu.text(569, "Молитва до святих Бориса і Гліба",
                "texts/molytvy-do-svyatykh/borysa-i-hliba.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
            .setAudio("07_Molytvy_do_ukrainskykh_sviatykh/36_Molytva_do_sviatyh_Borysa_i_Hliba.mp3",
                    SRC_AUDIO_KATEKH_KOMISIYA);
        menu.text(570, "Молитва до святого Антонія Печерського",
                "texts/molytvy-do-svyatykh/antoniya-pecherskoho.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
            .setAudio("07_Molytvy_do_ukrainskykh_sviatykh/37_Molytva_do_sv_Antoniya_Pecherskoho.mp3",
                    SRC_AUDIO_KATEKH_KOMISIYA);
        menu.text(571, "Молитва до святого Теодосія Печерського",
                "texts/molytvy-do-svyatykh/teodosiya-pechersokoho.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
            .setAudio("07_Molytvy_do_ukrainskykh_sviatykh/38_Molytva_do_sv_Teodosiya_Pecherskoho.mp3",
                    SRC_AUDIO_KATEKH_KOMISIYA);
        menu.text(572, "Молитва до святого Йосафата і мучеників",
                "texts/molytvy-do-svyatykh/josaphata-i-muchenykiv.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
            .setAudio("07_Molytvy_do_ukrainskykh_sviatykh/39_Molytva_do_sv_Yosafata_i_muchenykiv.mp3",
                    SRC_AUDIO_KATEKH_KOMISIYA);
        ...
        menu.text(574, "Молитва до всіх святих українського народу",
                ...
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
            .setAudio("07_Molytvy_do_ukrainskykh_sviatykh/40_Molytva_do_vsih_sviatyh_Ukrayinskoho_narodu.mp3",
                    SRC_AUDIO_KATEKH_KOMISIYA);
    ...
    private MenuItemSubMenu addMolytvyNaKozhenDen() {
        ...
        menu.html(86, "Молитва ранішнього намірення",
                ...
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("05_Molytvy_na_kozhnyi_den/05_Molytva_ranishnioho_namirennia.mp3",
                        SRC_AUDIO_KATEKH_KOMISIYA);
        menu.html(87, "Молитва св. Івана Золотоустого на кожну годину дня",
                "texts/na-kozhen-den/iv-zlatoust-kozn-hod-dnya.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("05_Molytvy_na_kozhnyi_den/06_Molytva_na_kozhnu_hodynu_dnia.mp3",
                        SRC_AUDIO_KATEKH_KOMISIYA);
        menu.html(88, "Неділя", "texts/na-kozhen-den/nedilya.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
            .setAudio("05_Molytvy_na_kozhnyi_den/07_Molytvy_v_nedilu.mp3",
                    SRC_AUDIO_KATEKH_KOMISIYA);
        menu.html(89, "Понеділок", "texts/na-kozhen-den/ponedilok.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
            .setAudio("05_Molytvy_na_kozhnyi_den/08_Molytva_v_ponedilok.mp3",
                    SRC_AUDIO_KATEKH_KOMISIYA);
        menu.html(90, "Вівторок", "texts/na-kozhen-den/vivtorok.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
            .setAudio("05_Molytvy_na_kozhnyi_den/09_Molytvy_u_vivtorok.mp3",
                    SRC_AUDIO_KATEKH_KOMISIYA);
        menu.html(91, "Середа і п’ятниця",
                "texts/na-kozhen-den/sereda-i-pyatnytsya.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
            .setAudio("05_Molytvy_na_kozhnyi_den/10_Molytvy_v_seredu_i_pyatnytsiu.mp3",
                    SRC_AUDIO_KATEKH_KOMISIYA);
        menu.html(92, "Четвер", "texts/na-kozhen-den/chetver.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
            .setAudio("05_Molytvy_na_kozhnyi_den/11_Molytvy_v_chetver.mp3",
                    SRC_AUDIO_KATEKH_KOMISIYA);
        menu.html(93, "Субота", "texts/na-kozhen-den/subota.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
            .setAudio("05_Molytvy_na_kozhnyi_den/12_Molytvy_v_subotu.mp3",
                    SRC_AUDIO_KATEKH_KOMISIYA);
        return menu;
    }
    ...
    private MenuItemSubMenu addKatekhPravdy() {
        ...
        menu.html(146, "Заповіді", "texts/kateh-pravdy/zapovidi.html",
            ...
            .setAudio("63_Katehyzmovi_pravdy.mp3", SRC_AUDIO_KATEKH_KOMISIYA);
    ...
    private MenuItemSubMenu addMolytvyRizniPotreby() {
        ...
        sm.html(184, "Молитва батьків за дітей",
                ...
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("06_Molytvy_na_rizni_potreby/23_Molytva_batkiv_za_ditey.mp3",
                        SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
        sm.html(185, "Молитва дітей за батьків",
                "texts/rizni-potreby/batky-dity/ditey-za-batkiv.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("06_Molytvy_na_rizni_potreby/24_Molytva_ditey_za_batkiv.mp3",
                        SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
        ...
        menu.html(4, "Молитви при трапезі", "texts/molytvy-pry-trapezi.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("04_Molytvy_pry_trapezi.mp3", SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
        menu.html(175, "Молитва подяки", "texts/rizni-potreby/podyaky.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA
        ).setAudio("06_Molytvy_na_rizni_potreby/13_Molytva_podiaky.mp3",
                SRC_AUDIO_KATEKH_KOMISIYA
        ).setOfficialUGCCText(true);
        menu.html(176, "Молитва на всяке прошення",
                "texts/rizni-potreby/vsyake-proshennya.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA
        ).setAudio("06_Molytvy_na_rizni_potreby/14_Molytva_na_vsake_proshennia.mp3",
                SRC_AUDIO_KATEKH_KOMISIYA
        ).setOfficialUGCCText(true);
        menu.html(177, "Молитва до Пресвятої Богородиці",
                "texts/rizni-potreby/do-presv-bohorod.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("06_Molytvy_na_rizni_potreby/15_Molytva_do_Presviatoyi_Bohorodytsi.mp3"
                        , SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
        menu.html(178, "Молитва у терпінні", "texts/rizni-potreby/u-terpinni.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("06_Molytvy_na_rizni_potreby/16_Molytva_u_terpinni.mp3",
                        SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
        menu.html(920, "Молитва до апостола Юди Тадея у важких обставинах життя",
                "texts/rizni-potreby/do_sv_yudy_tadeya.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("06_Molytvy_na_rizni_potreby/17_Molytva_do_sv_ap_Yudy_Tadeya.mp3",
                        SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
        menu.html(179, "Молитва за недужих", "texts/rizni-potreby/za-neduzhykh.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("06_Molytvy_na_rizni_potreby/18_Molytva_za_neduzhyh.mp3",
                        SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
        menu.html(180, "Молитва на всяку неміч",
                "texts/rizni-potreby/na-vsyaku-nemich.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("06_Molytvy_na_rizni_potreby/19_Molytva_na_vsaku_nemich.mp3",
                        SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
        menu.html(181, "Молитва при вмираючих",
                "texts/rizni-potreby/pry-vmyrayuchykh.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("06_Molytvy_na_rizni_potreby/20_Molytva_pry_vmyrayuchyh.mp3",
                        SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
        menu.html(182, "Молитва у годині смерти",
                "texts/rizni-potreby/u-hodyni-smerti.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("06_Molytvy_na_rizni_potreby/21_Molytva_u_hodyni_smerti.mp3",
                        SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
        ...
        menu.html(183, "Молитва християнської родини",
                ...
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("06_Molytvy_na_rizni_potreby/22_Molytva_hrystyyanskoyi_rodyny.mp3",
                        SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
        ...
        menu.html(187, "Молитва учня (учениці)", "texts/rizni-potreby/uchnya.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("06_Molytvy_na_rizni_potreby/25_Molytva_uchnia_(uchenytsi).mp3",
                        SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
        ...
        menu.html(188, "Молитва за перемогу над спокусами",
                ...
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("06_Molytvy_na_rizni_potreby/26_Molytva_za_peremohu_nad_spokusamy.mp3",
                        SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
        menu.html(189, "Молитва про духа покори",
                "texts/rizni-potreby/dukha-pokory.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("06_Molytvy_na_rizni_potreby/27_Molytva_pro_duha_pokory.mp3",
                        SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
        menu.html(190, "Молитва в день іменин",
                "texts/rizni-potreby/v-den-imenyn.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("06_Molytvy_na_rizni_potreby/28_Molytva_v_den_imenyn.mp3",
                        SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
        menu.html(191, "Молитва за того, хто хоче іти в путь",
                "texts/rizni-potreby/ity-v-put.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("06_Molytvy_na_rizni_potreby/29_Molytva_za_podorozhuyuchyh.mp3",
                        SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
        menu.html(192, "Молитва на благословення дому",
                "texts/rizni-potreby/blahoslovennya-domu.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("06_Molytvy_na_rizni_potreby/30_Molytva_na_blahoslovennia_domu.mp3",
                        SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
        menu.html(193, "Молитва на освячення всякої речі",
                "texts/rizni-potreby/osvyach-rechi.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("06_Molytvy_na_rizni_potreby/31_Molytva_na_osviachennia_vsiakoyi_rechi.mp3",
                        SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
        menu.html(194, "Молитви за з’єднання всіх християн",
                "texts/rizni-potreby/zyednannya-khrystyyan.html",
                SRC_MOLYTOVNYK_PRYJDITE_POKLONIMSYA)
                .setAudio("06_Molytvy_na_rizni_potreby/32_Molytva_za_zyednannia_vsih_hrystuyan.mp3",
                        SRC_AUDIO_KATEKH_KOMISIYA)
                .setOfficialUGCCText(true);
    ...
    private void addSources(Set<String> sources, MenuItemBase mi) {
        if (mi instanceof MenuItemPrayer) {
            ...
            String audioSrc = ((MenuItemPrayer) mi).getAudioSource();
            if (!TextUtils.isEmpty(audioSrc)) {
                sources.add(audioSrc);
            }
